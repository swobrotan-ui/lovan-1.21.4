...
import ru.levin.netdebug.AuditTestCommand;
...
public class CommandManager implements IMinecraft {
    ...
    public CommandManager() {
        ...
        register(new AuditTestCommand());
        register(new PanicCommand());
        register(new ParseCommand());
        register(new VclipCommand());
        register(new HclipCommand());
        register(new LocatorCommand());
        register(new GlobalLocatorCommand());
register(new ru.levin.x2demo.X2Command());
