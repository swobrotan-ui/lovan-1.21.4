...
public class FontUtils {
    ...
    public final String fontsDir = "/assets/sodiumextra/font/";
    ...
    public static volatile RenderFonts[] sfns_display_bold = new RenderFonts[256];
    ...
    public synchronized void init() {
        ...
        initializationFont(sfns_display_bold, "sfns-display-bold.ttf");
