...
public class StyleManager implements IMinecraft {
    ...
    public void init() {
        addStyle("Клиентский", "#FFFFFF", "#000000");
        addStyle("Бирюзовый", "#2EC4B6", "#2EC4B6");
        addStyle("Осень", "#FF7D00", "#FFD700");
        addStyle("Кислотный", "#CCFF00", "#00FF00");
        addStyle("Океан", "#0077BE", "#00B4D8");
        addStyle("Вишневый", "#8B0000", "#FF1493");
        addStyle("Аметист", "#9B6EFF", "#5433FF");
        addStyle("Лаванда", "#B06AB3", "#4568DC");
        addStyle("Лайм", "#6AFF00", "#00FFA8");
        addStyle("Закат", "#FF512F", "#F09819");
        addStyle("Небо", "#00C6FF", "#0072FF");
        addStyle("Пламя", "#F00000", "#DC281E");
        addStyle("Сакура", "#FF2DAA", "#FF6BD6");
        addStyle("Мята", "#00F5A0", "#00D9F5");
        addStyle("Графит", "#2B2D42", "#8D99AE");
        loadCustomThemes();
        if (!styles.isEmpty()) {
