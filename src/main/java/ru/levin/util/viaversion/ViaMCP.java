...
public class ViaMCP {
    ...
    public ViaMCP() {
        ...
        this.viaScreen = new VersionSelectScreen(Minecraft.getInstance().fontRenderer, 4, 4, 100, 20, ITextComponent.getTextComponentOrEmpty(ProtocolVersion.getProtocol(NATIVE_VERSION).getName()));
    }
}
