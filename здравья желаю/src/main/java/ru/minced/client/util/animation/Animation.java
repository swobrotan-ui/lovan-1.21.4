package ru.minced.client.util.animation;

import ru.minced.client.util.animation.bezier.Bezier;
import ru.minced.client.util.animation.bezier.list.CubicBezier;
import ru.minced.client.util.animation.util.Easing;
